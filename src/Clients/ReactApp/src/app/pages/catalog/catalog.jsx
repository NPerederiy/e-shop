...
const CatalogPage = ({
    ...
    const items = [
        ...
        },
        {
            ...
            price: '4999',
            img: 'https://i.citrus.ua/imgcache/size_800/uploads/shop/e/4/e4a54aaf283b3662b4af644f5bdd9ce8.jpg',
            discount: '3999'
        },
        {
            id: 4,
            name: 'Игровая клавиатура Razer Mercury Edition Purple Switch (RZ03-03390300-R3M1)',
            price: '3499',
            img: 'https://i.citrus.ua/imgcache/size_800/uploads/shop/a/d/ad7d3fcd33d7f27d7a257e4cef82bd94.jpg',
            discount: '2999'
        },
        {
            id: 5,
